...
import 'package:ayurcare/decoction/dec_diarrhea.dart';
...
import 'package:ayurcare/remedies/rem_diarrhea.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_diarrhea()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_diarrhea()),
                      );
                    },
                    child: Container(
                       width: 175,
