...
import 'package:ayurcare/decoction/dec_headache.dart';
...
import 'package:ayurcare/remedies/rem_headache.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_headache()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_headache()),
                      );
                    },
                    child: Container(
                       width: 175,
