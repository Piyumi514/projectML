...
import 'package:ayurcare/decoction/dec_constipation.dart';
...
import 'package:ayurcare/remedies/rem_constipation.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_constipation()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_constipation()),
                      );
                    },
                    child: Container(
                       width: 175,
