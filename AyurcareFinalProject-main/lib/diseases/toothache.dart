...
import 'package:ayurcare/decoction/dec_toothache.dart';
...
import 'package:ayurcare/remedies/rem_toothache.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_toothache()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_toothache()),
                      );
                    },
                    child: Container(
                       width: 175,
