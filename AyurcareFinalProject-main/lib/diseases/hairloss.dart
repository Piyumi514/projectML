...
import 'package:ayurcare/decoction/dec_hairloss.dart';
...
import 'package:ayurcare/remedies/rem_hairloss.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_hairloss()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_hairloss()),
                      );
                    },
                    child: Container(
                       width: 175,
