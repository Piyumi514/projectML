...
import 'package:ayurcare/decoction/dec_indigestion.dart';
...
import 'package:ayurcare/remedies/rem_indigestion.dart';
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const rem_indigestion()),
                      );
                    },
                    child: Container(
                      width: 175,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const dec_indigestion()),
                      );
                    },
                    child: Container(
                       width: 175,
